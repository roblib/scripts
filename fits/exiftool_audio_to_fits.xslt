...
<xsl:template match="/">
    ...
    <fits xmlns="http://hul.harvard.edu/ois/xml/ns/fits/fits_output">
		...
		<metadata>
		<audio>
			<!-- rob added these to pull out the RIFF tags from wav files-->
			<Encoding>
			...
			<AvgBytesPerSec>
				<xsl:value-of select="exiftool/AvgBytesPerSec"/>
			</AvgBytesPerSec>
			...
			<Product>
				<xsl:value-of select="exiftool/Product"/>
			</Product>
			
			<Artist>
				<xsl:value-of select="exiftool/Artist"/>
			</Artist>
			
			<DateCreated>
				<xsl:value-of select="exiftool/DateCreated"/>
			</DateCreated>
			
			<Duration>
				<xsl:value-of select="exiftool/Duration"/>
			</Duration>
			<!-- end of robs additions -->
			<xsl:choose>
